package com.example.dell.explisview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareListData() {
        ...
        // Adding child data
        listDataHeader.add("Keshika Tank");
        listDataHeader.add("Mehul Singhal");
        listDataHeader.add("Naman Khurpia");
        ...
        listDataChild.put(listDataHeader.get(1), MehulSinghal);
        listDataChild.put(listDataHeader.get(2), NamanKhurpia);
    }
}
